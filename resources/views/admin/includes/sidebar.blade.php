                 ...
                 <div id="sidebar-menu">
                     <ul class="sidebar-links" id="simple-bar">
                         ...
                         <li class="sidebar-list">
                             ...
                             @endif
                             <a class="sidebar-link sidebar-title {{ $active }}"
                                 href="{{ url('/admin/categories') }}"><i data-feather="list"></i>
                                 <span>Categories</span></a>
                         </li>
                         <li class="sidebar-list">
                            @if (Session::get('admin_page') == 'log')
                                @php $active = "side-active" @endphp
                            @else
                                @php $active = "" @endphp
                            @endif
                            <a class="sidebar-link sidebar-title {{ $active }}" href="#"><i
                                    data-feather="file-text"></i><span>Log sheet</span></a>
                            <ul class="sidebar-submenu">
                                <li><a href="{{route('admin.purchaseIndex')}}">Purchase log</a></li>
                                <li><a href="{{route('admin.salesIndex')}}">Sales log</a></li>
                            </ul>
                        </li>
                         <li class="sidebar-list">
                         ...
                         <li class="sidebar-list">
                             ...
                             @endif
                             <a class="sidebar-link sidebar-title {{ $active }}" href="#"><i
                                     data-feather="shopping-cart"></i><span>Product In/Out</span></a>
                             <ul class="sidebar-submenu">
