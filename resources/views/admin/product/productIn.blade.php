                    ...
                    <div class="card">
                        <div class="card-header d-flex justify-content-between">
                            ...
                            <a class="btn btn-primary cart-btn-transform pull-right"
                                href="{{ route('admin.products.create') }}">Add new Product</a>
                        </div>
                                            ...
                                            <div class="modal-dialog modal-dialog-centered" role="document">
                                                <div class="modal-content">
                                                    ...
                                                    @endif
                                                        ...
                                                        <hr>
                                                        <form action="{{route('admin.products.addStock',$item->id)}}" method="post">
                                                            @csrf
                                                            <label for="stock_add"> <strong> Quantity: </strong></label>
                                                            <input type="number" value="{{old('stock_add')}}" name="stock_add">
                                                            <button type="submit" value="Add Stock" class="btn btn-success btn-sm">Product In</button>
                                                        </form>
                                                    </div>
                                                </div>
                                            </div>
