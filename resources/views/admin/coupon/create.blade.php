    ...
    <div class="row">
      <div class="col-sm-12">
        <div class="card">
          ...
          <form class="form theme-form" method="post" action="{{route('admin.coupons.store')}}" enctype="multipart/form-data">
            @csrf
            <div class="card-body">
              <div class="row">
                <div class="col">
                  <div class="mb-3">
                    ...
                    <input class="form-control" name="coupon_code" type="text" placeholder="Coupon Code" value="{{old('coupon_code')}}">
                  </div>
                </div>
              </div>
              <div class="row">
                <div class="col">
                  <div class="mb-3">
                    ...
                    <input class="form-control" name="discount" type="number" min="0" step="0.1" max="100" placeholder="Coupon discount in percentage" value="{{old('discount')}}" >
                  </div>
                </div>
              </div>
              <div class="row">
                <div class="col">
                  <div class="mb-3">
                    ...
                    <input class="form-control" name="expiry_date" type="date" data-language="en" placeholder="Enter expiry date"  min="{{date("Y-m-d")}}" value="{{old('expiry_date')}}">
                  </div>
                </div>
              </div>
              <div class="row">
